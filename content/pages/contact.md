...
Infra monitors and participates in these email addresses:
  ...
  - Use `security@infra.apache.org` to report **infrastructure-related** security issues. See the third entry on <a href="https://infra.apache.org/infra-contact.html">Contacting Infra</a> about reporting a security issue specific to an ASF project or a project's product.
